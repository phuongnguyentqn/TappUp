"""
Django settings for gh_apps project.
...
SECRET_KEY = os.getenv(
    'SECRET_KEY', 'no0k@o&adz%d6d5$y0-(r+1s37^t*zhd!pdi#ba#iuvbu$l4dp'
)
...
WSGI_APPLICATION = 'gh_apps.wsgi.application'
